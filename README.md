...
- Skilled in Adobe Illustrator, Photoshop, and Figma for professional and modern designs  
- Strong understanding of color theory, typography, and design principles  
- Proven ability to deliver unique, creative, and impactful concepts for businesses and personal brands  

---

🌱 **Currently Deepening Knowledge In**

- Advanced React.js: Hooks, Context API, Performance Optimization, React Router, focusing on building complete frontend applications  
- Tailwind CSS: Utility-first CSS framework for fast and responsive UI design  
- Django REST Framework (DRF): Developing robust REST APIs and full-stack integration with React  
- Node.js & Express: Backend architecture, REST APIs, JWT authentication, and server-side logic for full-stack apps  
- MongoDB & Firebase: NoSQL databases, realtime backend solutions, and cloud integration  
- C++ STL: Efficient data structures & algorithms for competitive programming  
